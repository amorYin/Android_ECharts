...
//           Android && Android.showMessage(msg);
    ...
    function initChartOptions() {
        ...
        var echartJson = option;//Android.getChartOptions();
        return echartJson;
    }
...
//        option = preTask(option);
    ...
    function onEchartViewAction(param) {
        showDebugMessage("onEchartViewAction:" + param);
        if (typeof Android !== 'undefined') {
           Android && Android.onEChartActionEventResponse(JSON.stringify(param));
        }
    }
    ...
    function removeEchartViewAction(param) {
        ...
        if (typeof Android !== 'undefined') {
            Android && Android.removeEChartActionEventResponse(JSON.stringify(param));
        }
    }
